...
const UserManager = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 dark:bg-gray-800 dark:text-white min-h-screen">
      ...
      {/* ユーザー追加セクション */}
      <div className="mb-8 p-6 bg-white dark:bg-gray-700 shadow-md rounded">
        ...
        <div className="flex gap-4">
          <input
            ...
            className="p-2 border border-gray-300 dark:border-gray-600 rounded w-1/3 bg-white dark:bg-gray-800 text-black dark:text-white"
          />
          <input
            type="text"
      ...
      <table className="table-auto w-full bg-white dark:bg-gray-700 shadow-md rounded">
